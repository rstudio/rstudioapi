...
#'
#' @details The data frame of package dependencies contains the following
#'   columns: \describe{
#'   \item{name}{The name of the R package.}
#'   \item{version}{The required minimum version of the R package.}
#'   \item{location}{Where RStudio expects the package to be, \code{cran} for
#'     a CRAN-like repository or \code{embedded} for development packages
#'     embedded in RStudio itself.}
